...
const steps = [
  {
    ...
    description: "Свяжитесь с нами любым удобным способом: форма на сайте, телефон, WhatsApp или email. Опишите ваш груз, откуда и куда нужна доставка.",
    time: "5 минут",
  ...
  },
  {
    ...
    description: "Организуем забор груза, таможенное оформление и транспортировку. Контролируем каждый этап. Вы видите статус в реальном времени.",
    time: "от 3 дней",
  ...
  },
  {
    ...
    description: "Доставляем груз точно в срок. Помогаем с разгрузкой если нужно. Предоставляем полный пакет документов.",
    time: "по графику",
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <p className="text-lg text-muted-foreground font-light leading-relaxed">
            4 шага от заявки до получения груза. Прозрачно, понятно, без сюрпризов.
          </p>
        </div>
