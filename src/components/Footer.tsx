          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group cursor-pointer">
                ...
                <span className="text-[15px] text-zinc-400 group-hover:text-white transition-colors duration-300 font-light">+7 (812) 644-02-91</span>
              </li>
              <li className="flex items-start gap-3 group cursor-pointer">
                <Mail className="h-5 w-5 mt-0.5 text-accent group-hover:scale-125 transition-all duration-300 ease-out" strokeWidth={2} />
                <span className="text-[15px] text-zinc-400 group-hover:text-white transition-colors duration-300 font-light">info@armaxstp.com</span>
              </li>
              <li className="flex items-start gap-3 group cursor-pointer">
